...
Route::group(['middleware' => ['auth']], function () {
		...
		Route::get('/subcategory/list',['as'=>'subcategory-list','uses'=>'SubcategoryController@index']);
		Route::get('/subcategory/create',['as'=>'subcategory','uses'=>'SubcategoryController@create']);
		Route::post('/subcategory/create',['as'=>'subcategory','uses'=>'SubcategoryController@store']);
